	 ...
	 <button type="button" 
      ...
      <div class="collapse navbar-collapse" id="navbarNav2">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a href="signup.php" class="nav-link brand-style">Get Started</a>
          </li>
          <li class="nav-item">
            <a href="driverdashboard.php" class="nav-link brand-style">Rent</a>
          </li>
          <li class="nav-item">
            <a href="carownerdashboard.php" class="nav-link brand-style">List</a>
          </li>
          <li class="nav-item dropdown">
            <a href="index.php" class="nav-link dropdown-toggle brand-style"  id="navbarDropdown"
